      ...
      sections: [
        {
          ...
          items: [
            { name: 'Tops', href: '/col' },
            { name: 'Dresses', href: '/col' },
            { name: 'Pants', href: '/col' },
            { name: 'Denim', href: '/col' },
            { name: 'Sweaters', href: '/col' },
            { name: 'T-Shirts', href: '/col' },
            { name: 'Jackets', href: '/col' },
            { name: 'Activewear', href: '/col' },
            { name: 'Browse All', href: '/col' },
          ],
        },
        {
          id: 'accessories',
        ...
        },
        {
          ...
          name: 'Brands',
          items: [
            { name: 'Full Nelson', href: '/product' },
            { name: 'My Way', href: '/product' },
            { name: 'Re-Arranged', href: '/product' },
            { name: 'Counterfeit', href: '/product' },
            { name: 'Significant Other', href: '/product' },
          ],
        },
      ],
    },
...
const footerNavigation = {
  ...
  company: [
    { name: 'Who we are', href: '/product' },
    { name: 'Sustainability', href: '/product' },
    { name: 'Press', href: '/product' },
    { name: 'Careers', href: '/product' },
    { name: 'Terms & Conditions', href: '/product' },
    { name: 'Privacy', href: '/product' },
  ],
  customerService: [
    { name: 'Contact', href: '/product' },
    { name: 'Shipping', href: '/product' },
    { name: 'Returns', href: '/product' },
    { name: 'Warranty', href: '/product' },
    { name: 'Secure Payments', href: '/product' },
    { name: 'FAQ', href: '/product' },
    { name: 'Find a store', href: '/product' },
  ],
}
