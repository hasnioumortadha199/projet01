...
const categories = [
  ...
  { name: 'Sale', href: '/col', imageSrc: 'https://tailwindui.com/img/ecommerce-images/home-page-01-category-03.jpg' },
]
const collections = [
  {
      ...
      <main>
        ...
        <section aria-labelledby="category-heading" className="pt-24 sm:pt-32 xl:mx-auto xl:max-w-7xl xl:px-8">
          <div className="px-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8 xl:px-0">
            ...
            <a href="/category" className="hidden text-sm font-semibold text-indigo-600 hover:text-indigo-500 sm:block">
          ...
          <div className="mt-6 px-4 sm:hidden">
            <a href="col" className="block text-sm font-semibold text-indigo-600 hover:text-indigo-500">
              Browse all categories 
              <span aria-hidden="true"> &rarr;</span>
            </a>
          </div>
      ...
      <footer aria-labelledby="footer-heading" className="bg-gray-900">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="border-t border-gray-800 py-10">
            <p className="text-sm text-gray-400">Copyright &copy; 2023 Morserv, Inc.</p>
          </div>
        </div>
      </footer>
    </div>
